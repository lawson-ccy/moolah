...
contract StableSwapPoolERC20Test is Test {
  ...
  function setUp() public {
    ...
    assertEq(pool.price0DiffThreshold(), 1e16); // 1% price diff threshold
    assertEq(pool.price1DiffThreshold(), 1e16); // 1% price diff threshold
  }
  ...
  function test_swap_token0_to_token1() public {
    ...
    pool.exchange(0, 1, 100 ether, 0); // 0: token0, 1: token1, amountIn: amount of token0 to swap, 0: min amount out
